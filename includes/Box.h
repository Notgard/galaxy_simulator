...
namespace quadtree
{
    ...
    public:
        ...
        constexpr Box(T Left = 0, T Top = 0, T Width = 0, T Height = 0) noexcept : left(Left), top(Top), width(Width), height(Height)
        {
        }
        ...
        {
            return Vector2<T>(left + width * 0.5, top + height * 0.5);
        }
